...
export default function DisclosurePage() {
  return (
    ...
    >
      ...
      <p>
        当サイトの記事には、広告、アフィリエイトリンク、PRリンクが含まれる場合があります。リンク経由で購入や登録が行われた場合、当サイトが報酬を受け取ることがあります。
      </p>

      <h2>掲載基準</h2>
      <p>
        商品やサービスは、記事のテーマや読者の目的に合うものを掲載します。報酬の有無だけでなく、始めやすさ、費用、使いやすさ、継続しやすさを重視します。
      </p>
