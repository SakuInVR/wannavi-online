...
export function UnlockCard({ articleId, slug }: UnlockCardProps) {
  ...
  return (
    <div className="relative mt-8 overflow-hidden rounded-2xl border border-sky-500/20 bg-gradient-to-b from-slate-950 via-slate-950 to-sky-950/20 p-8 shadow-2xl">
            ...
            <>
              {credits !== null && credits > 0 ? (
                ...
                <div className="w-full max-w-sm rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 text-center">
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">アンロックするにはクレジットの購入が必要です。</p>
                  <Link
                    href="/dashboard"
